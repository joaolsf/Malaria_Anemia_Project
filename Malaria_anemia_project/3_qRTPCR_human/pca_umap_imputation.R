...
setwd("/Users/joaoluizsfilho/Dropbox/Work_Files/Matthias_Lab/Projects/Severe_Anemia_project/3_Nanostring_human/qRTPCR_human")
...
write.csv(mydata_complete, "qRTPCR_BM_gene_expression_complete.csv")
