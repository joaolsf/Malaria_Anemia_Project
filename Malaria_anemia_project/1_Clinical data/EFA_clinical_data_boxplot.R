...
multiplex <- read.csv("Cohort_anemia_clinical_data_factor_scores_iteration1_boxplots.csv")

multiplex$title <- "Clinical signature 5"
p <- ggplot(multiplex, aes(x=Clinical_group, y=Clinical_signature5, fill=Clinical_group,)) +
