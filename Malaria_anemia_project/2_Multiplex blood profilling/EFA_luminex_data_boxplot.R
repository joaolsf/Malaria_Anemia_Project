...
setwd("/Users/joaoluizsfilho/Dropbox/Work_Files/Matthias_Lab/Projects/Severe_Anemia_project/2_Luminex/3_EFA")
...
multiplex$title <- "PB signature 3"
p <- ggplot(multiplex, aes(x=Clinical_group, y=PBS3, fill=Clinical_group,)) +
