...
#Small values (8.679451e-95 < 0.05) of the significance level indicate that a factor analysis may be useful with our data.
det(cor(mydata))
...
write.csv(fa.none$scores, "Cohort_anemia_luminex_data_factor_scores_iteration1.csv")
write.csv(fa.none$loadings, "Cohort_anemia_luminex_data_factor_loadings_iteration1.csv")
