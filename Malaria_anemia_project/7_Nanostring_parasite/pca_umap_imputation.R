...
multiplex <- read.csv("parasite_expression_pb_v1_pca.csv")
...
df_to_cluster.active <- df_to_cluster[,2:457]
...
write.csv(mydata_complete, "parasite_expression_pb_v1_pca_complete.csv")
...
library(ggrepel)
library(viridis)
multiplex <- read.csv("parasite_expression_pb_v1_pca_complete.csv")
...
#subsetting active variables for the PCA
df_to_cluster.active <- df_to_cluster[,2:456]
...
# color coding according to the tissue
...
# Heatmap of normalised expression in the BM and PB, Moderate and severe anemia
...
multiplex <- read.csv("parasite_expression_bm_pb_heatmap.csv")

# category 1
outcome <- multiplex$Tissue
cats <- ifelse(outcome <= 1, "Bone marrow", 'Peripheral blood')

# category 2
outcome2 <- multiplex$Group
...
#subsetting active variables for the PCA
df_to_cluster.active <- df_to_cluster[,4:459]
