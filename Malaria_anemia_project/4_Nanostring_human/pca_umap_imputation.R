...
setwd("/Users/joaoluizsfilho/Dropbox/Work_Files/Matthias_Lab/Projects/Severe_Anemia_project/3_Nanostring_human")
...
df_to_cluster.active <- df_to_cluster[,3:40] #remove housekeeping genes
...
write.csv(mydata_complete, "cohort_anemia_nanostring_human_BM_complete.csv")
...
#subsetting active variables for the PCA
df_to_cluster.active <- df_to_cluster[,3:40]
