...
#Small values (1.309395e-128 < 0.05) of the significance level indicate that a factor analysis may be useful with our data.
det(cor(mydata))
...
write.csv(fa.none$scores, "BM_nanostring_factor_scores_iteration1.csv")
write.csv(fa.none$loadings, "BM_nanostring_factor_loadings_iteration1.csv")
