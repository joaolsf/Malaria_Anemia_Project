...
#BOX PLOTS
multiplex <- read.csv("PB_luminex_nanostring_qRTPCR_factor_scores_iteration1_boxplot.csv")

multiplex$title <- "PB signature 1"
p <- ggplot(multiplex, aes(x=Clinical_group, y=PBS1, fill=Clinical_group,)) +
