...
setwd("/Users/joaoluizsfilho/Dropbox/Work_Files/Matthias_Lab/Projects/Severe_Anemia_project/4_Nanostring_human/8_Correlations/Nanostring_clinical")
...
write.csv(cor$r , "Correlation_spearman_nanostring_clinical_BM_rvalues_severe.csv")
write.csv(cor$P , "Correlation_spearman_nanostring_clinical_BM_pvalues_severe.csv")
write.csv(cor2$P , "Correlation_spearman_nanostring_clinical_BM_adjustpvalues_severe.csv")

# reading file (importar o arquivo)
multiplex2 <- read.csv("./BM/Correlation_spearman_nanostring_clinical_BM_rvalues_severe.csv")
multiplex3 <- read.csv("./BM/Correlation_spearman_nanostring_clinical_BM_pvalues_severe.csv")
multiplex4 <- read.csv("./BM/Correlation_spearman_nanostring_clinical_BM_adjustpvalues_severe.csv")
...
# reading file (importar o arquivo)
multiplex <- read.csv("PB_nanostring_clinical_correlation.csv")
...
#Extract r and p values to plot a corr plot for the correlation of specific variables
write.csv(cor$r , "Correlation_spearman_nanostring_clinical_PB_rvalues_moderate.csv")
write.csv(cor$P , "Correlation_spearman_nanostring_clinical_PB_pvalues_moderate.csv")
write.csv(cor2$P , "Correlation_spearman_nanostring_clinical_PB_adjustpvalues_moderate.csv")

# reading file (importar o arquivo)
multiplex2 <- read.csv("./PB/Correlation_spearman_nanostring_clinical_PB_rvalues_moderate.csv")
multiplex3 <- read.csv("./PB/Correlation_spearman_nanostring_clinical_PB_pvalues_moderate.csv")
multiplex4 <- read.csv("./PB/Correlation_spearman_nanostring_clinical_PB_adjustpvalues_moderate.csv")
