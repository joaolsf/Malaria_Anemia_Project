...
multiplex <- read.csv("EFA_BM_nanostring_qRTPCR.csv")
...
df_to_cluster.active <- df_to_cluster[,2:50]
...
write.csv(mydata_complete, "EFA_BM_nanostring_qRTPCR_complete.csv")
...
multiplex <- read.csv("EFA_BM_nanostring_qRTPCR_complete.csv")

# data frame para cluster
df_to_cluster <- multiplex[,-1]
rownames(df_to_cluster) <- multiplex$PatientID
df_to_cluster.active <- df_to_cluster[,2:50] #remove housekeeping genes
...
write.csv(fa.none$scores, "BM_nanostring_qRTPCR_factor_scores_iteration1.csv")
write.csv(fa.none$loadings, "BM_nanostring_qRTPCR_factor_loadings_iteration1.csv")
